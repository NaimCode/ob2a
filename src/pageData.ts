export const pageData = {
  ...
  features: [
    ...
    },
    {
      ...
      title: "Brillance",
      description:
        "Donnez à vos cheveux un éclat naturel et sain qui attire tous les regards.",
    },
    {
      icon: "💪",
      title: "Force",
      description:
        "Renforcez vos cheveux de l'intérieur pour réduire la casse et favoriser la croissance.",
    },
  ],
  testimonials: [
    {
